...
// Datos actualizados con la propiedad "link"
const projects = [
  {
    id: 1,
    title: "CYBER CHIC",
    ...
    size: "md:col-span-1",
    link: "https://tu-demo-url.com/cyber-chic", // <-- URL REAL AQUÍ
  },
  {
    id: 2,
    title: "TERRA BEAN",
    ...
    image:
      "https://images.unsplash.com/photo-1590856029826-c7a73142bbf1?q=80&w=1000&auto=format&fit=crop",
    size: "md:col-span-1",
    link: "https://tu-demo-url.com/terra-bean",
  },
  {
    id: 3,
    title: "SONAR FEST",
    ...
    size: "md:col-span-2",
    link: "https://tu-demo-url.com/sonar-fest",
  },
  {
    id: 4,
    title: "Esmae",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          ...
          <div className="mb-2">
            <a
              href="#"
              className="group flex items-center gap-2 text-sm font-bold uppercase tracking-widest hover:text-criv-blue transition-colors"
            >
